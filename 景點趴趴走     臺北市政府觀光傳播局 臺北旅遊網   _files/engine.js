...
dwr.engine._origScriptSessionId = "A86D5993E9AFD4A6238640C5702070A2";
      ...
      if (!contentType.match(/^text\/plain/) && !contentType.match(/^text\/javascript/)) {
        ...
        if (batch.isPoll && batch.map.partialResponse == dwr.engine._partialResponseYes) {
          ...
          if (reply.search("//#DWR") == -1) {
            dwr.engine._handleWarning(batch, { name:"dwr.engine.invalidReply", message:"Invalid modify by ginger server" });
          }
          else {
            toEval = reply;
          }
